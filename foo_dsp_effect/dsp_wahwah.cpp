...
class CMyDSPWahWindow : public CDialogImpl<CMyDSPWahWindow>, private DSPConfigNotify
{
public:
	CMyDSPWahWindow() {
...
class CMyDSPPopupWah : public CDialogImpl<CMyDSPPopupWah>, private DSPConfigNotify
{
public:
